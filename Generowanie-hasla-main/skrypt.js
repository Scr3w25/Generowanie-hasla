...
function wybZnakowS(){
    iloscZnakowS=document.getElementById("iloscZnakowS").value;
    document.getElementById("wybZnakowS").value=iloscZnakowS;
    ustaWolne();
}
function wybierzDuzychL(){
        iloscDuzychL=document.getElementById("iloscDuzychL").value;
        document.getElementById("wybierzDuzychL").value=iloscDuzychL;
    ustaWolne();
}
function ustaWolne(){
    iloscWolnychZn=iloscZn-iloscCyfr-iloscMaleL-iloscZnakowS-iloscDuzychL;
